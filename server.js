...
const bikeRoutes = require("./services/bikeService");
const serviceRoutes = require("./services/bike-washService");
const orderRoutes = require("./services/orderService");
const mechanicRoutes = require("./services/mechanicService");
...
app.use("/admin/bike-services", serviceRoutes);
...
app.listen(port, () => {
  console.log(`server is listening on admin ${port}`);
});
